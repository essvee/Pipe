...
from annette.models import ExtractedCitation, Citation, Session, Name, Taxonomy, Metrics, Access
from annette.models.log import RunLogManager
...
with RunLogManager(session) as logger:
    ...
    identified_citations, id_extractedcitations = IdentifyCrossRef(mystery_extractedcitations).get_crossref_match()
